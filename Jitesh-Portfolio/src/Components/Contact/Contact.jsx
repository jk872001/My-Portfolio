		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='mailto: jiteshkumar872001@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/jk872001'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/jiteshkumar101/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Jitesh Kumar, 2022 All rights
				reserved.
			</div>
		</footer>
	);
